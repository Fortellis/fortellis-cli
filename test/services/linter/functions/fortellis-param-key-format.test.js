...
describe('function fortellisParamKeyFormat', async function () {
  ...
  it('should fail keys with invalid prefix', async function () {
    ...
    for(const t of tests) {
      const result = fortellisParamKeyFormat(t.key);
      expect(result).to.eql([{
        message: "invalid prefix `foo`. Prefix should be `header`,`path`,`query`, or `body`"
      }]);
    }
  });
  ...
  it("should fail if the `header` parameter object key is not Upper-Kebab-Case", async function () {
    ...
    for(const t of tests) {
      const result = fortellisParamKeyFormat(t.key);
      expect(result).to.eql([{
        message:"suffix is incorrect case. The suffix of `header` parameter objects should be `Upper-Kebab-Case`"
      }]);
    }
  });
  ...
  it("should fail if the `path` parameter object key suffix is not camelCase", async function () {
    ...
    for(const t of tests) {
      const result = fortellisParamKeyFormat(t.key);
      expect(result).to.eql([{
        message: "suffix is incorrect case. The suffix of `path` parameter objects should be `camelCase`"
      }]);
    }
  });
  ...
  it("should fail if the `query` parameter object key suffix is not camelCase", async function () {
    ...
    for(const t of tests) {
      const result = fortellisParamKeyFormat(t.key);
      expect(result).to.eql([{
        message: "suffix is incorrect case. The suffix of `query` parameter objects should be `camelCase`"
      }]);
    }
  });
  ...
  it("should fail if the `body` parameter object key suffix is not PascalCase", async function () {
    ...
    for(const t of tests) {
      const result = fortellisParamKeyFormat(t.key);
      expect(result).to.eql([{
        message: "suffix is incorrect case. The suffix of `body` parameter objects should be `PascalCase`"
      }]);
    }
  });
});